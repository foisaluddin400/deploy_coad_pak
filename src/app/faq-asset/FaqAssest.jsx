...
const FaqAssetSeller = () => {
  const { data: faq, isLoading } = useGetFaqQuery({ userRole: 'Asset Seller' });
    ...
    <div>
      ...
      <div className="container m-auto py-11">
        <h1 className="text-3xl mb-4 font-bold">
          FAQ for <span className="text-[#22C55E]">Business Asset Listers</span>
        </h1>
