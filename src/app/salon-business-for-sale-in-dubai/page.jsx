...
import SalonBusiness from './SalonBusinessForSaleInDubai'

export const metadata = {
  title: "Salon Business for Sale in Dubai",
  description:
    "Explore profitable salon business for sale in Dubai. Ideal investment with prime location, steady clients, and growth potential. Contact now!",
  alternates: {
    canonical: "https://profitablebusinessesforsale.com/salon-business-for-sale-in-dubai"
  },
};
